                    ...
                    <tbody>
                        <?php foreach ($itemList as $list) { ?>
                            <tr class="gradeX">
                                ...
                                <td><?php $pharmacies->load($list['pharmacy_id']); echo $list['pharmacy_id'] . " - " . $pharmacies->name;?></td>
                                <td><?php $members->load($list['user_id']); echo $members->first_name . ' ' . $members->last_name; ?></td>
