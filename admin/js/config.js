...
if($.fn.wl_Chart) $.fn.wl_Chart.defaults = {
	...
	lineWidth: null,
	legend: true,
	legendPosition: "nw", // or "nw" or "se" or "sw"
	tooltip: true,
	tooltipGravity: 'n',
	tooltipPattern: function (value, legend, label, id, itemobj) {
		return "Unit " + unitNumber(value) + " Sold for $" + numberWithCommas(value) + " on " + label + ' \xA0'+'\xA0'+'\xA0'+'\xA0'+ '\xA0'+'\xA0'+'\xA0'+'\xA0' + legend + " "; //(" + id + ")";
	},
	//tooltipPattern: "value is %1 from %2 at %3 (%4)", //also possible
	orientation: 'horizontal',
	colors: ['#990000', '#0000E6', '#006600', '#313121', '#9999FF', '#333333'], //'#b2e7b2', '#f0b7b7', '#b5f0f0', '#e8e8b3', '#efb7ef', '#bbb6f0'
	flot: {},
