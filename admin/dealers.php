...
$dealerslist = $dealers->getlist($type="dealer");
...
<head>
	<meta charset="utf-8">
	<title><?PHP echo SITE_TITLE;?> - Dealers</title>
...
<?php include("admin_header.php"); ?>
        ...
        <div class="widget" id="widget_breadcrumb">
					...
					<div>
						<ul class="breadcrumb" data-numbers="true">
                            ...
                            <li><a href="<?php echo HTTP_HOME_URL;?>admin/dealers.php">List Physicians</a></li>
		...
		<div class="g12 nodrop">
			...
			<p></p>
				...
				<thead>
					<tr>
						<th>Full Name </th><th>Clinic</th><th>Email</th><th>Action</th>
					</tr>
				</thead>
				<tbody>
                <?php foreach($dealerslist as $list) { ?>
					<tr class="gradeX">
                        ...
                        <td class="c"><a href="manage_dealers.php?request=<?php echo $list['id'];?>">Update</a> | 
