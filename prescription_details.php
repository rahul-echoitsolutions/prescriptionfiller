...
<img src="images/review-your-prescriptions.jpg" style="width: 100%;">
	...
	$pres_image = ($prescriptions->image_binary)?"<img src=\"data:image/jpeg;base64, {$prescriptions->image_binary}\"; >":'';
...
?>
          ...
          echo $physicians->first_name." ".$physicians->last_name; ?><br /><br />
