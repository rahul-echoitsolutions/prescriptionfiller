...
function changeCarDetailsPic(index) {
	...
	eval("document.detail_car_container_img").src = "http://carcorneredmonton.com/inventory/images/"+thumbarray[currentThumbIndex-1];
...
function loadnewThumbpic() {	
		document.detail_car_container_img.src = "http://carcorneredmonton.com/inventory/images/"+thumbarray[currentThumbIndex-1];
...
function getNextZoomPic() {
	...
	document.zoom_pic.src = "http://carcorneredmonton.com/inventory/images/zoom_"+thumbarray[currentZoomIndex];
	$("#zoompic").fadeIn(500);	
...
function openZoomPic(id, title) {
	...
	//alert("ok");
	var loadform = "http://carcorneredmonton.com/scripts/_zoompic.php?filen=http://carcorneredmonton.com/inventory/images/zoom_"+thumbarray[currentZoomIndex]+"&id="+id+"&h="+h+"&w="+w;
