...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var base = "/LiveEditor/LiveEditor/images"; /*Relative to Root*/
...
<body style="margin:0px;background:#ffffff;font-family:Arvo;font-size:12px">
    ...
    <div id="topPanel" style="display:block;top:0px;left:0px;width:100%;padding:15px;background:#fcfcfc;border-bottom:#f7f7f7 1px solid;border-right:#f7f7f7 1px solid">
    ...
    <div id="container_id" style="padding:15px;margin-top:0px;">
    </div>
